...
from yandex.cloud.loadtesting.api.v1.test_service_pb2 import GetTestRequest, CreateTestRequest, CreateTestMetadata
...
from yandex.cloud.loadtesting.api.v1.config_service_pb2 import CreateConfigRequest, CreateConfigMetadata
from yandex.cloud.loadtesting.api.v1.test.single_agent_configuration_pb2 import SingleAgentConfiguration
...
from yandex.cloud.loadtesting.api.v1.report_service_pb2 import GetTableReportRequest, GetTableReportResponse
import uuid
import time
from grpc._channel import _InactiveRpcError
from common import generate_create_agent_request, wait_for_agent_to_be_ready, DEFAULT_AGENT_NAME_PREFIX, FOLDER_ID
...
def test_test_creation(sdk: yandexcloud.SDK, create_agent_for_test):
    ...
    create_config_operation = config_stub.Create(CreateConfigRequest(folder_id=FOLDER_ID, yaml_string=TEST_CONFIG))
